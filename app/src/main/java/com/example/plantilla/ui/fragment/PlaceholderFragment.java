...
public class PlaceholderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        alName = new ArrayList<>(Arrays.asList(getString(R.string.chat), getString(R.string.recicleviews), getString(R.string.camara), getString(R.string.sqllite), getString(R.string.sqllite),  getString(R.string.sqllite),  getString(R.string.sqllite)));
        alImage = new ArrayList<>(Arrays.asList(R.drawable.histoclinica, R.drawable.examen, R.drawable.disponible, R.drawable.consulta, R.drawable.cuidsalud, R.drawable.webrtcportalconetividad, R.drawable.familia));
